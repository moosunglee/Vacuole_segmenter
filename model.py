...
## Implement U-Net - https://github.com/pykao/Modified-3D-UNet-Pytorch/blob/master/model.py
class UNet(nn.Module):
    def __init__(self, in_channels=1, n_classes=1, base_n_filter = 64):
        ...
        self.dropout3d = nn.Dropout3d(p=0.75)
    ...
    def forward(self, x):
        ...
        # seg_layer = out
        # out = out.contiguous().view(1, self.n_classes) # NCZYX -> NZYXC
